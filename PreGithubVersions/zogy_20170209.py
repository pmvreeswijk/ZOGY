...
timing = False           # (wall-)time the different functions
...
# PMV 2017/01/11: edited Barak's original code to include variances
# sigma_n**2 and sigma_r**2 (see Eq. 9, here sn and sr) and Fn and Fr which
# are assumed to be unity in Barak's code.
def optimal_binary_image_subtraction_pmv(R,N,Pr,Pn,sr,sn,fr,fn,Vr,Vn,dx,dy):
