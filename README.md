...
Written by Paul Vreeswijk with vital input from Barak Zackay and Eran Ofek and adapted by Kerry Paterson for intergration into MeerLICHT pipeline (subpipe).
